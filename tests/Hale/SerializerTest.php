...
class SerializerTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $s = new \Hale\Serializer('secretkey', 'testing');
    ...
    {
        $dummy = $this->getMock(
            'Hale\DummySerializer', array(), array(), 'DummySerializer'
        );
        $s = new \Hale\Serializer('secretkey', 'testing', '.', 'default', $dummy);
    ...
    public function testDumpPayload()
    {
        ...
        $dummy = $this->getMock('Hale\DummySerializer');
    ...
    public function testLoadPayload()
    {
        ...
        $s = new \Hale\Serializer('secretkey', 'testing', $dummy);
    ...
    {
        $s = new \Hale\Serializer('secretkey', 'testing');
        $this->assertInstanceOf('Hale\Signer', $s->getSigner());
    }

    public function testGetCustomSigner()
    {
        $dummy = $this->getMock(
            'Hale\DummySigner', array(), array(), 'DummySigner'
        );
        $s = new \Hale\Serializer(
